            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>Please <span class="label label-danger">login</span> to make an appointment. </p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h3>Empowering Health, One Appointment at a Time</h3>
                    <hr>
                    <h5>Your Health, Your Time: Book with Ease.</h5>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Pathological lab tests</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed sequi debitis sunt iste excepturi vero, ducimus hic odit culpa doloribus.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vitae inventore libero at hic expedita est impedit saepe dolorem aut cumque!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum consequuntur corrupti suscipit sed et provident id amet voluptatibus eius esse!</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Feedback</h4>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Pariatur modi saepe, sit minus odio aperiam ullam nesciunt doloribus ipsum nam?</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
